namespace WindowsFormsProject
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "Суммарную зарплату по департаменту";
            ...
            this.button2.Text = "Зарплата максимальна";
            ...
            this.button3.Text = "Зарплаты руководителей департаментов (по убыванию)";
